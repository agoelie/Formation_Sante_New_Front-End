...
//   const users = [
//     { id: 1, name: "TOTO", email: "toto@gamil.com", role: "Admin", status: "Actif" },
//     { id: 2, name: "Jean BOBO", email: "jean@gamil.com", role: "Admin", status: "Inactif" },
//     { id: 3, name: "TATA Bine", email: "tata@gamil.com", role: "Simple", status: "Actif" },
//     { id: 4, name: "NONO Nomie", email: "nono@gamil.com", role: "Admin", status: "Inactif" },
//     { id: 5, name: "BOSSOU Toni", email: "toni@gamil.com", role: "Simple", status: "Actif" },
//     { id: 6, name: "BOSSOU Mimi", email: "mimi@gamil.com", role: "Simple", status: "Actif" },
//   ];
...
//   return (
//     <div className="bg-white shadow-xl rounded-2xl p-6 w-full h-screen flex flex-col">
//       {/* Header */}
//       <div className="flex items-center justify-between mb-6">
//         <h2 className="text-3xl font-bold text-gray-800">👥 Utilisateurs</h2>
  ...
  return (
    <div className="bg-white shadow-xl rounded-2xl p-6 w-full h-screen flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800">👥 Utilisateurs</h2>
        <div className="flex gap-2 flex-wrap">
          <button className="flex items-center gap-2 px-3 md:px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow transition text-sm md:text-base">
            <UserPlus size={18} /> Ajouter un Admin
          </button>
          <button className="flex items-center gap-2 px-3 md:px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg shadow transition text-sm md:text-base">
            <Ban size={18} /> Bloquer
          </button>
          <button className="flex items-center gap-2 px-3 md:px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow transition text-sm md:text-base">
            <Unlock size={18} /> Débloquer
          </button>
        </div>
      </div>
      ...
      {/* Table scrollable et responsive */}

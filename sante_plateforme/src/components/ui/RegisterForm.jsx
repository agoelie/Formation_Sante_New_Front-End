...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gray-50 boder border-blue-900">
...
//             type="text"
//             placeholder="Name"
//             className="w-full px-4 py-2 rounded-md bg-blue-900 text-white placeholder-gray-200 focus:outline-none mb-4"
//           />

//           {/* Prénom */}
//           <label className="block text-sm font-semibold mb-2">Prenom</label>
//           <input
//             type="text"
//             placeholder="Prenom"
//             className="w-full px-4 py-2 rounded-md bg-blue-900 text-white placeholder-gray-200 focus:outline-none mb-4"
...
//             type="email"
//             placeholder="Email"
//             className="w-full px-4 py-2 rounded-md bg-blue-900 text-white placeholder-gray-200 focus:outline-none mb-6"
//           />

//           {/* Bouton */}
//           <button
//             type="submit"
//             className="w-full py-3 bg-green-900 text-white font-semibold rounded-md hover:bg-green-800 transition"
//           >
//             S’inscrire
//           </button>
//         </form>

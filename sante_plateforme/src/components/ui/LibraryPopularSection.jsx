...
export default function PopularCourses() {
  ...
  const filteredCourses = courses.filter(
    (course) =>
      (activeCategory === "Tout" || course.category === activeCategory) &&
    ...
    <section className="px-6 py-10 max-w-7xl mx-auto">
      ...
      <div className="flex justify-center mb-6">
        <input
          ...
          className="w-full max-w-lg border-2 border-blue-500 rounded-lg px-5 py-3 
                     text-gray-700 shadow-md focus:outline-none 
                     focus:ring-4 focus:ring-blue-300 text-lg"
        />
      </div>
